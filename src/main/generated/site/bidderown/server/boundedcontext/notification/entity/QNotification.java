...
public class QNotification extends EntityPathBase<Notification> {
    ...
    private static final long serialVersionUID = 1330524967L;
    ...
    public final site.bidderown.server.boundedcontext.member.entity.QMember receiver;
    ...
    public QNotification(Class<? extends Notification> type, PathMetadata metadata, PathInits inits) {
        ...
        this.receiver = inits.isInitialized("receiver") ? new site.bidderown.server.boundedcontext.member.entity.QMember(forProperty("receiver")) : null;
    }
