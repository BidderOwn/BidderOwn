...
public class QBid extends EntityPathBase<Bid> {
    ...
    private static final long serialVersionUID = -1215885460L;
    ...
    public final site.bidderown.server.bounded_context.member.entity.QMember bidder;
    ...
    public QBid(Class<? extends Bid> type, PathMetadata metadata, PathInits inits) {
        ...
        this.bidder = inits.isInitialized("bidder") ? new site.bidderown.server.bounded_context.member.entity.QMember(forProperty("bidder")) : null;
