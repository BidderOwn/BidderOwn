...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = -353148116L;
    ...
    public final site.bidderown.server.bounded_context.member.entity.QMember writer;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.writer = inits.isInitialized("writer") ? new site.bidderown.server.bounded_context.member.entity.QMember(forProperty("writer")) : null;
    }
